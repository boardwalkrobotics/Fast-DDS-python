...
{
public:
    using DomainParticipantListener::DomainParticipantListener; // Inherit constructors
    ...
    {
        PYBIND11_OVERLOAD(void, DomainParticipantListener, on_type_discovery, participant, request_sample_id, topic, identifier, object, dyn_type);
    }
    ...
    {
        PYBIND11_OVERLOAD(void, DomainParticipantListener, on_type_dependencies_reply, participant, request_sample_id, dependencies);
    }
    ...
    {
        PYBIND11_OVERLOAD(void, DomainParticipantListener, on_type_information_received, participant, topic_name, type_name, type_information);
    }
};
...
public:
    ...
    bool serialize(void *data, SerializedPayload_t *payload) override
    {
        ...
        char *buffer;
        ssize_t length;
        if (PyBytes_AsStringAndSize(result_bytes.ptr(), &buffer, &length) != -1)
        {
...
PYBIND11_MODULE(fastdds_pybind, m)
{
    ...
    py::class_<SerializedPayload_t>(m, "SerializedPayload_t")
        .def(py::init<>())
        .def_property("data", [](SerializedPayload_t &self) -> py::bytes
                      { return py::bytes(reinterpret_cast<char *>(self.data), self.length); }, [](SerializedPayload_t &self, py::bytes bytes)
                      {
            char* buffer;
            ssize_t length;
    ...
    py::class_<TopicDataType, PyTopicDataType>(m, "TopicDataType")
        ...
        .def("serialize", [](TopicDataType &self, py::object data, SerializedPayload_t *payload)
        ...
        .def("getTypeSupport", [](TopicDataType &self)
             { return create_type_support(&self); })
    ...
    py::class_<TypeSupport>(m, "TypeSupport")
        ...
        .def("register_type", py::overload_cast<DomainParticipant *, std::string>(&TypeSupport::register_type, py::const_))
        .def("get_type_name", &TypeSupport::get_type_name)
        .def("serialize", py::overload_cast<void *, SerializedPayload_t *>(&TypeSupport::serialize));

    py::class_<TopicQos>(m, "TopicQos")
        .def(py::init<>());

    py::class_<TopicListener>(m, "TopicListener")
        .def(py::init<>());
    ...
    py::class_<ReturnCode_t>(m, "ReturnCode_t")
        ...
        .def("__str__", [](const ReturnCode_t &rc)
             {
            switch (rc())
            {
        ...
        .def_property_readonly_static("RETCODE_OK", [](py::object)
                                      { return ReturnCode_t::RETCODE_OK; })
        .def_property_readonly_static("RETCODE_ERROR", [](py::object)
                                      { return ReturnCode_t::RETCODE_ERROR; })
        .def_property_readonly_static("RETCODE_UNSUPPORTED", [](py::object)
                                      { return ReturnCode_t::RETCODE_UNSUPPORTED; })
        .def_property_readonly_static("RETCODE_BAD_PARAMETER", [](py::object)
                                      { return ReturnCode_t::RETCODE_BAD_PARAMETER; })
        .def_property_readonly_static("RETCODE_PRECONDITION_NOT_MET", [](py::object)
                                      { return ReturnCode_t::RETCODE_PRECONDITION_NOT_MET; })
        .def_property_readonly_static("RETCODE_OUT_OF_RESOURCES", [](py::object)
                                      { return ReturnCode_t::RETCODE_OUT_OF_RESOURCES; })
        .def_property_readonly_static("RETCODE_NOT_ENABLED", [](py::object)
                                      { return ReturnCode_t::RETCODE_NOT_ENABLED; })
        .def_property_readonly_static("RETCODE_IMMUTABLE_POLICY", [](py::object)
                                      { return ReturnCode_t::RETCODE_IMMUTABLE_POLICY; })
        .def_property_readonly_static("RETCODE_INCONSISTENT_POLICY", [](py::object)
                                      { return ReturnCode_t::RETCODE_INCONSISTENT_POLICY; })
        .def_property_readonly_static("RETCODE_ALREADY_DELETED", [](py::object)
                                      { return ReturnCode_t::RETCODE_ALREADY_DELETED; })
        .def_property_readonly_static("RETCODE_TIMEOUT", [](py::object)
                                      { return ReturnCode_t::RETCODE_TIMEOUT; })
        .def_property_readonly_static("RETCODE_NO_DATA", [](py::object)
                                      { return ReturnCode_t::RETCODE_NO_DATA; })
        .def_property_readonly_static("RETCODE_ILLEGAL_OPERATION", [](py::object)
                                      { return ReturnCode_t::RETCODE_ILLEGAL_OPERATION; })
        .def_property_readonly_static("RETCODE_NOT_ALLOWED_BY_SECURITY", [](py::object)
    ...
    //     .value("RETCODE_PRECONDITION_NOT_MET", ReturnCode_t::RETCODE_PRECONDITION_NOT_MET)
    //     .value("RETCODE_OUT_OF_RESOURCES", ReturnCode_t::RETCODE_OUT_OF_RESOURCES)
    //     .value("RETCODE_NOT_ENABLED", ReturnCode_t::RETCODE_NOT_ENABLED)
    //     .value("RETCODE_IMMUTABLE_POLICY", ReturnCode_t::RETCODE_IMMUTABLE_POLICY)
    //     .value("RETCODE_INCONSISTENT_POLICY", ReturnCode_t::RETCODE_INCONSISTENT_POLICY)
    //     .value("RETCODE_ALREADY_DELETED", ReturnCode_t::RETCODE_ALREADY_DELETED)
    //     .value("RETCODE_TIMEOUT", ReturnCode_t::RETCODE_TIMEOUT)
    //     .value("RETCODE_NO_DATA", ReturnCode_t::RETCODE_NO_DATA)
    //     .value("RETCODE_ILLEGAL_OPERATION", ReturnCode_t::RETCODE_ILLEGAL_OPERATION)
    //     .value("RETCODE_NOT_ALLOWED_BY_SECURITY", ReturnCode_t::RETCODE_NOT_ALLOWED_BY_SECURITY);
    ...
    //     .def_readwrite("total_count_change", &PublicationMatchedStatus::total_count_change)
    //     .def_readwrite("current_count", &PublicationMatchedStatus::current_count)
    //     .def_readwrite("current_count_change", &PublicationMatchedStatus::current_count_change);
    ...
    //     .def_readwrite("total_count_change", &SubscriptionMatchedStatus::total_count_change)
    //     .def_readwrite("current_count", &SubscriptionMatchedStatus::current_count)
    //     .def_readwrite("current_count_change", &SubscriptionMatchedStatus::current_count_change);
    ...
    py::class_<PublisherQos>(m, "PublisherQos")
        .def(py::init<>())
        .def_property("presentation", [](const PublisherQos &qos)
                      { return qos.presentation(); }, [](PublisherQos &qos, const eprosima::fastdds::dds::PresentationQosPolicy &presentation)
                      { qos.presentation(presentation); })
        .def_property("partition", [](const PublisherQos &qos)
                      { return qos.partition(); }, [](PublisherQos &qos, const eprosima::fastdds::dds::PartitionQosPolicy &partition)
                      { qos.partition(partition); })
        .def_property("group_data", [](const PublisherQos &qos)
                      { return qos.group_data().data_vec(); }, [](PublisherQos &qos, const std::vector<eprosima::fastrtps::rtps::octet> &data)
    ...
    py::class_<Publisher>(m, "Publisher")
        .def("create_datawriter", [](Publisher &self, Topic &topic, const DataWriterQos &qos, DataWriterListener *listener, const StatusMask &mask)
             { return self.create_datawriter(&topic, qos, listener, mask); }, py::arg("topic"), py::arg("qos"), py::arg("listener") = nullptr, py::arg("mask") = StatusMask::all())
        .def("get_default_datawriter_qos", static_cast<const DataWriterQos &(Publisher::*)() const>(&Publisher::get_default_datawriter_qos));

    // py::class_<DataReader>(m, "DataReader")
    //     .def("read_next_sample", &DataReader::read_next_sample);

    py::class_<DataReaderQos>(m, "DataReaderQos")
        .def(py::init<>());
    ...
    py::class_<SubscriberQos>(m, "SubscriberQos")
        .def(py::init<>())
        .def_property("presentation", [](const SubscriberQos &qos)
                      { return qos.presentation(); }, [](SubscriberQos &qos, const eprosima::fastdds::dds::PresentationQosPolicy &presentation)
                      { qos.presentation(presentation); })
        .def_property("partition", [](const SubscriberQos &qos)
                      { return qos.partition(); }, [](SubscriberQos &qos, const eprosima::fastdds::dds::PartitionQosPolicy &partition)
                      { qos.partition(partition); })
        .def_property("group_data", [](const SubscriberQos &qos)
                      { return qos.group_data().data_vec(); }, [](SubscriberQos &qos, const std::vector<eprosima::fastrtps::rtps::octet> &data)
                      { qos.group_data().data_vec(data); })
        .def_property("entity_factory", [](const SubscriberQos &qos)
                      { return qos.entity_factory(); }, [](SubscriberQos &qos, const eprosima::fastdds::dds::EntityFactoryQosPolicy &entity_factory)
                      { qos.entity_factory(entity_factory); });

    py::class_<SubscriberListener>(m, "SubscriberListener")
        .def(py::init<>());

    py::class_<Subscriber>(m, "Subscriber")
        .def("create_datareader", &Subscriber::create_datareader);

    py::class_<DomainParticipantQos>(m, "DomainParticipantQos")
        .def(py::init<>())
        // .def_property("user_data", [](const DomainParticipantQos &qos)
        //               { return qos.user_data().data_vec(); }, [](DomainParticipantQos &qos, const std::vector<eprosima::fastrtps::rtps::octet> &data)
        //               { qos.user_data().data_vec(data); })
        // .def_property("entity_factory", [](const DomainParticipantQos &qos)
        //               { return qos.entity_factory(); }, [](DomainParticipantQos &qos, const EntityFactoryQosPolicy &entity_factory)
        //               { qos.entity_factory() = entity_factory; })
        // .def_property("partition", [](const DomainParticipantQos &qos)
        //               { return qos.partition(); }, [](DomainParticipantQos &qos, const PartitionQosPolicy &partition)
        //               { qos.partition() = partition; })
        // .def_property("wire_protocol", [](const DomainParticipantQos &qos)
        //               { return qos.wire_protocol(); }, [](DomainParticipantQos &qos, const WireProtocolConfigQos &wire_protocol)
        //               { qos.wire_protocol() = wire_protocol; })
        // .def_property("transport", [](const DomainParticipantQos &qos)
        //               { return qos.transport(); }, [](DomainParticipantQos &qos, const TransportConfigQos &transport)
        //               { qos.transport() = transport; })
        .def_property("name", [](const DomainParticipantQos &qos)
                      { return qos.name(); }, [](DomainParticipantQos &qos, const std::string &name)
                      { qos.name(name); })
        .def("properties", [](DomainParticipantQos &qos)
             { return py::cast(qos.properties()); })
        .def("flow_controllers", [](DomainParticipantQos &qos)
             { return py::cast(qos.flow_controllers()); });

    py::class_<DomainParticipantListener, PyDomainParticipantListener, std::shared_ptr<DomainParticipantListener>>(m, "DomainParticipantListener")
        .def(py::init<>())
        // .def("on_participant_discovery", py::overload_cast<DomainParticipant*, eprosima::fastrtps::rtps::ParticipantDiscoveryInfo&&> (&DomainParticipantListener::on_participant_discovery))
        // .def("on_subscriber_discovery", py::overload_cast<DomainParticipant*, eprosima::fastrtps::rtps::ReaderDiscoveryInfo&&> (&DomainParticipantListener::on_subscriber_discovery))
        // .def("on_publisher_discovery", py::overload_cast<DomainParticipant*, eprosima::fastrtps::rtps::WriterDiscoveryInfo&&> (&DomainParticipantListener::on_publisher_discovery))
    ...
    py::class_<DomainParticipant>(m, "DomainParticipant")
        .def("create_publisher", &DomainParticipant::create_publisher, py::arg("qos") = PUBLISHER_QOS_DEFAULT, py::arg("listener").none(true) = py::none(), py::arg("mask") = StatusMask::all())
        .def("create_subscriber", &DomainParticipant::create_subscriber, py::arg("qos") = SUBSCRIBER_QOS_DEFAULT, py::arg("listener") = py::none(), py::arg("mask") = StatusMask::all())
        .def("create_topic",
             &DomainParticipant::create_topic,
             py::arg("topic_name"),
             py::arg("type_name"),
             py::arg("qos") = TOPIC_QOS_DEFAULT,
             py::arg("listener").none(true) = py::none(),
             py::arg("mask") = StatusMask::all())
        .def("get_qos", static_cast<const DomainParticipantQos &(DomainParticipant::*)() const>(&DomainParticipant::get_qos))
        .def("set_qos", &DomainParticipant::set_qos)
        .def("get_default_publisher_qos", static_cast<const PublisherQos &(DomainParticipant::*)() const>(&DomainParticipant::get_default_publisher_qos))
        .def("get_listener", &DomainParticipant::get_listener, py::return_value_policy::reference_internal)
        .def("set_listener", py::overload_cast<DomainParticipantListener *, const StatusMask &>(&DomainParticipant::set_listener), py::arg("listener"), py::arg("mask") = StatusMask::all())
    ...
    py::class_<DomainParticipantFactory, std::unique_ptr<DomainParticipantFactory, py::nodelete>>(m, "DomainParticipantFactory")
        .def(py::init([]()
                      { return DomainParticipantFactory::get_instance(); }))
        .def("create_participant", &DomainParticipantFactory::create_participant, py::arg("domain_id") = 0, py::arg("qos") = PARTICIPANT_QOS_DEFAULT, py::arg("listener").none(true) = py::none(), py::arg("mask") = StatusMask::all());
}